    ...
    <body class=" site-navbar-small">
        ...
        <div class="page animsition">
            <div class="page-header">
                <h1 class="page-title">Thematics</h1>
                <ol class="breadcrumb">
                    <li><a href="#">Admin</a></li>

                    <li class="active">Thematic</li>
                </ol>
            ...
            <div class="page-content container-fluid">
                ...
                if (isset($_POST['add'])) {
                    ...
                    $new_group->setthematicarea($name, $target_group);
                }
                ?>
                ...
                <div class="panel">
                    <header class="panel-heading">
                        <h3 class="panel-title">Thematics</h3>
                    </header>
                    <div class=" pull-right" style="margin-bottom: 15px;padding-right: 20px;">
                        <button class="btn btn-info" data-target="#exampleNiftySlideFromRight" data-toggle="modal"
                                type="button">New Thematic</button>
                    </div>
                    ...
                    <div class="modal-dialog">
                        <form class="modal-content" method="post">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="exampleFormModalLabel">New Thematic</h4>
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 form-group">
                                        <input type="text" class="form-control" name="thematic" placeholder=" Name">
                                    </div>
